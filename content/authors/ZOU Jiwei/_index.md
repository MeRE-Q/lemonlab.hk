...
bio: My research interests include Thermal comfort, Urban microclimate, Climate change, CFD and Field measurement and Machine Learning.

interests:
  - Thermal comfort
  - Urban microclimate
  - Climate change
  - CFD and Field measurement
  - Machine Learning
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:merejinji.liu@polyu.edu.hk'
  # - icon: twitter
  #   icon_pack: fab
  #   link: https://twitter.com/GeorgeCushen
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=q75CT0YAAAAJ&hl=zh-CN
  # - icon: github
  #   icon_pack: fab
...
email: 'merejinji.liu@polyu.edu.hk'
